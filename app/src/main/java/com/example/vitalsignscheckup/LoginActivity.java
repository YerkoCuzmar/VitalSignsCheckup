        ...
        btnRegister.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                if (!name.isEmpty() && !email.isEmpty() && !pass.isEmpty() && !mobile.isEmpty()){
                    ...
                    Toast.makeText(LoginActivity.this, "Debes completar todos los datos", Toast.LENGTH_SHORT).show();
                }
            }
        });
                    ...
                    mDataBase.child("Users").child(id).setValue(map).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task2) {
                            if(task2.isSuccessful()){ //tarea ahora es crear datos en la bd
                                ...
                                Toast.makeText(LoginActivity.this, "No se pudieron crear los datos", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
