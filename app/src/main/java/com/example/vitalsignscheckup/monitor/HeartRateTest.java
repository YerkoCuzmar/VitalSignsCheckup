...
import com.example.vitalsignscheckup.monitor.viewmodel.HeartRateViewModel;
...
public class HeartRateTest extends AppCompatActivity {
    ...
    private HeartRateService mService;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this).get(HeartRateViewModel.class);
        ...
        mViewModel.getBinder().observe(this, new Observer<HeartRateService.MyBinder>() {
            @Override
            public void onChanged(HeartRateService.MyBinder myBinder) {
                if(myBinder != null){
