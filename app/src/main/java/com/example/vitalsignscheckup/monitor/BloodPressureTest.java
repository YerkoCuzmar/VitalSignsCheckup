...
import com.example.vitalsignscheckup.monitor.viewmodel.BloodPressureViewModel;

public class BloodPressureTest extends AppCompatActivity {
    ...
    private BloodPressureService mService;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewModel.getBinder().observe(this, new Observer<BloodPressureService.MyBinder>() {
            @Override
            public void onChanged(BloodPressureService.MyBinder myBinder) {
                if(myBinder != null){
