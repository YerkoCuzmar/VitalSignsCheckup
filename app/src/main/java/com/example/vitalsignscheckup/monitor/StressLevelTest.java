...
import com.example.vitalsignscheckup.monitor.viewmodel.StressLevelViewModel;

public class StressLevelTest extends AppCompatActivity {

    private static final String TAG = "StressLevelActivity";
    ...
    private StressLevelService mService;
    private StressLevelViewModel mViewModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this).get(StressLevelViewModel.class);
        ...
        mViewModel.getBinder().observe(this, new Observer<StressLevelService.MyBinder>() {
            @Override
            public void onChanged(StressLevelService.MyBinder myBinder) {
                if(myBinder != null){
    ...
    private void startService(){
        Intent serviceIntent = new Intent(this, StressLevelService.class);
