...
public class ServiceTemperatureTest extends Service {
    ...
    public class MyBinder extends Binder{
        ServiceTemperatureTest getService(){
            return ServiceTemperatureTest.this; // se retorna instancia del servicio
        }
    }
