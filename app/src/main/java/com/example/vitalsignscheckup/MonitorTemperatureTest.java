...
public class MonitorTemperatureTest extends AppCompatActivity {
    ...
    private MonitorTemperatureViewModelTest mViewModel;      //viewModel
    ...
    public void onCreate(Bundle savedInstanceState) {
        Log.d(TAG, "onCreate: se crea actividad");
        ...
        mViewModel = ViewModelProviders.of(this).get(MonitorTemperatureViewModelTest.class);

        mViewModel.getBinder().observe(this, new Observer<ServiceTemperatureTest.MyBinder>(){

            @Override
            public void onChanged(ServiceTemperatureTest.MyBinder myBinder){
                if(myBinder != null){
    ...
    private void startService(){
        Intent serviceIntent = new Intent(this, ServiceTemperatureTest.class);
